              ...
              <DialogHeader>
                  ...
                  <div className="mt-2">
                    {imagePreview ? (
                      ...
                      <div 
                        ...
                        className="border-2 border-dashed border-gray-300 rounded-md p-6 text-center hover:border-gray-400 cursor-pointer transition-colors"
                      >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      value={newStory.run_type}
                      onChange={(e) => setNewStory(prev => ({ ...prev, run_type: e.target.value }))}
                      className="w-full mt-1 p-2 border rounded-md"
                    >
                      <option value="sprint">Sprint Challenge</option>
                      <option value="renewable">Renewable Purchase</option>
                      <option value="questionnaire">Carbon Assessment</option>
                      <option value="pledge">Community Pledge</option>
                    </select>
                  </div>
                  <div>
                    ...
                    <Input
                      type="number"
                      value={newStory.points_earned}
                      onChange={(e) => setNewStory(prev => ({ ...prev, points_earned: parseInt(e.target.value) || 0 }))}
                      placeholder="0"
                    />
                  </div>
                </div>
